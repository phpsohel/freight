...
<body class="hold-transition login-page" style="background-image:url('{{asset('image/background.jpg')}}');min-height: 100%;background-size: cover;background-position: center;">
